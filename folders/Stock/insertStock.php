<?php
	...
	if($connection === false) {
		...
		mysqli_query($connection,"INSERT INTO stock (`product_id`, `color_id`, `spent`, `mobile_id`, `inStock`, `date`) 
					VALUES (".$product.", ".$color.", ".$spent.", ".$mobile.", ".$inStock.", '".$aux."')") 
		...
		/*Insert statement*/
		$information="<b>Compra</b> de um(a) ";	
